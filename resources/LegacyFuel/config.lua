...
Config.Strings = {
	...
	CancelFuelingPump = "Press ~g~E ~w~to cancel fueling",
	CancelFuelingJerryCan = "Press ~g~E ~w~to cancel fueling",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Press ~g~E ~w~to grab jerry can"
	Config.Strings.RefillJerryCan = "Press ~g~E ~w~ to refill jerry can"
end
