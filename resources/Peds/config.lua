...
Config.Locations1 = { -- Some Shop & Interior NPCs
	...
	{ x = 24.20,    y = -1347.60, z = 28.50, heading = 271.32 },    -- 24/7 Strawberry
	{ x = 2557.46,  y = 380.49,   z = 107.62,heading = 4.25 },      -- 24/7 Mountains Freeway
	{ x = 549.27,   y = 2671.82,  z = 41.16, heading = 100.35 },    -- 24/7 Sandy Shores
	{ x = 1727.62,  y = 6415.18,  z = 34.04, heading = 241.98 },    -- 24/7 Chilliad Freeway
	{ x = -3241.96, y = 999.86,   z = 11.83, heading = 4.68 },      -- 24/7 cumash Freeway
	{ x = -3038.68, y = 584.38,   z = 6.91,  heading = 24.72 },     -- 24/7 Ocean Freeway

    -- LT Gasoline --
	{ x = -706.13,  y = -915.38,  z = 18.22, heading = 60.33 },     -- LT Gasoline1
	{ x = -47.14,   y = -1758.82, z = 28.42, heading = 46.58 },     -- LT Gasoline2
	{ x = 1165.09,  y = -323.51,  z = 69.21, heading = 93.72 },     -- LT Gasoline3
	{ x = 1697.35,  y = 4923.32,  z = 41.06, heading = 332.42 },    -- LT Gasoline4
	{ x = -2966.12, y = 391.35,   z = 14.04, heading = 77.04 },     -- LT Gasoline5
	{ x = -1819.51, y = 793.72,   z = 137.08,heading = 134.72 },    -- LT Gasoline5
	...
	-- Gun Stores --
	{ x = -661.03,  y = -933.54,  z = 20.80, heading = 143.19 },    -- 1
	{ x = 1692.34,  y = 3761.12,  z = 34.50, heading = 220.75 },    -- 2

	-- Random --
	{ x = 308.95,   y = -594.17, z = 42.90, heading = 35.16 },     -- Central Hospital Main

	-- Banks --
	{ x = 149.75,   y = -1042.19, z = 29.0, heading = 355.82 },    -- 1

	-- Impounds -- Done
	{ x = 1776.34,   y = 3322.45, z = 40.20, heading = 32.9 },    -- Vehicle Impound
...
Config.Locations11 = { -- Nightclub Guards
	...
	-- Strip Club --
	--{ x = 117.4,      y = -1295.6, z = 28.29,   heading = 303.91 },	-- Vanilla1
