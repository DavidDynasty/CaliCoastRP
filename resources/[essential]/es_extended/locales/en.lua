Locales['en'] = {
  ...
  ['gave_ammo'] = 'you gave ~o~%sx~s~ shot to ~y~%s~s~',
  ['received_ammo'] = 'you received ~o~$%s~s~ shot from ~b~%s~s~',
  ['gave_money'] = 'you gave ~g~%s SEK~s~ to ~y~%s~s~',
  ['received_money'] = 'you received ~g~%s SEK~s~ from ~b~%s~s~',
