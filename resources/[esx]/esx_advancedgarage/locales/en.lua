Locales['en'] = {
	...
	['return'] = 'Return',
	['store_vehicles'] = 'Store Vehicle',
	['press_to_enter'] = 'Press ~INPUT_PICKUP~ to take vehicle out of garage',
	['press_to_delete'] = 'Press ~INPUT_PICKUP~ to store vehicle in garage',
	['press_to_impound'] = 'Press ~INPUT_PICKUP~ to access the impound',
	['spacer1'] = 'If vehicle is not here, check the impound',
	...
	-- Cars
	['garage_cars'] = 'Public Parking Garage',
	['pound_cars'] = 'Car Impound Lot',
	...
	-- Boats
	['garage_boats'] = 'Boat Dock',
	['pound_boats'] = 'Boat Impound Dock',
	...
	-- Aircrafts
	['garage_aircrafts'] = 'Aircraft Hanger',
	['pound_aircrafts'] = 'Aircraft Impound Hanger',
