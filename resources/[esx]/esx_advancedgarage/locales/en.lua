Locales['en'] = {
	...
	['press_to_enter'] = '~INPUT_PICKUP~ Retrieve Vehicle',
	['press_to_delete'] = '~INPUT_PICKUP~ Store Vehicle',
	['press_to_impound'] = '~INPUT_PICKUP~ Access Impound.',
	['you_paid'] = 'You paid $',
	...
	['cannot_store_vehicle'] = 'Nice try you thief!',
