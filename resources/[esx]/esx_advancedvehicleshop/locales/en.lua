Locales['en'] = {
  ...
  ['sell_menu'] = '~INPUT_CONTEXT~ sell ~y~%s~s~ for ~g~$%s~s~',
  ['generic_shopitem'] = '$%s',
  ['buy_vehicle'] = 'do you want to purchase %s for $%s?',
  ['buy_license'] = 'buy License?',
  ['sold_for'] = '~y~Sold~s~ ~b~%s~s~ for ~g~$%s~s~',
  ...
  -- Car Shop
  ['car_menu'] = '~INPUT_CONTEXT~ ~g~Car Shop',
  ['car_dealer'] = 'Car Dealership',
  ['car_missing'] = 'you don\'t have a driver\'s License!',
  ['car_belongs'] = 'The car with plate ~y~%s~s~ belongs to you',
  ['car_purchased'] = 'you bought a Car',
  -- Truck Shop
  ['truck_menu'] = '~INPUT_CONTEXT~ ~c~Truck Shop',
