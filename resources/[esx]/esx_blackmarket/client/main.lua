    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used < silencer then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped yourself with a Silencer. It will re-equip every return to town.")) 
		  		 	used = used + 1
		  	...
		  	elseif currentWeaponHash == GetHashKey("WEAPON_SNIPERRIFLE") then
	               ...
	               used = used + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in your hands, or your weapon can not take a Silencer."))
		  		
			end
			else
					  		 ESX.ShowNotification(("You have no more Silencer\'s to add.")) 
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used2 < flashlight then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped yourself with a Flashlight. It will re-equip every return to town.")) 
					   used2 = used2 + 1
		  	...
		  	elseif currentWeaponHash == GetHashKey("WEAPON_MARKSMANRIFLE") then
	               ...
	               used2 = used2 + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in your hands, or your weapon can not take a Flashlight."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You have no more Flashlight\'s to add"))
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used3 < grip then
			...
			if currentWeaponHash == GetHashKey("WEAPON_COMBATPDW") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped yourself with a Grip. It will re-equip every return to town.")) 
		  		   used3 = used3 + 1
		  	...
		  	elseif currentWeaponHash == GetHashKey("WEAPON_MARKSMANRIFLE") then
	               ...
	               used3 = used3 + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in your hands, or your weapon can not take a Grip."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You have no more Grip\'s to add"))
		end
end)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used4 < yusuf then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped your Deluxe Weapon Skin. It will re-equip every return to town.")) 
		  		   used4 = used4 + 1
			...
			elseif currentWeaponHash == GetHashKey("WEAPON_PUMPSHOTGUN") then
		  	...
		  	elseif currentWeaponHash == GetHashKey("WEAPON_ADVANCEDRIFLE") then
	               ...
	               used4 = used4 + 1
		  		  ...
		  		  ESX.ShowNotification(("You do not have a weapon in your hands. or your weapon can not take a Deluxe Skin."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You have no more Deluxe Skin\'s to add"))
	...
	local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used5 < magazine then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
				   ...
				   ESX.ShowNotification(("You have just equipped yourself with an Extended Magazine. It will re-equip every return to town.")) 
					   used5 = used5 + 1
			  ...
			  elseif currentWeaponHash == GetHashKey("WEAPON_BULLPUPRIFLE") then
				   ...
				   used5 = used5 + 1
					...
					ESX.ShowNotification(("You do not have a weapon in your hands, or your weapon can not take an Extended Magazine."))
				  
			end
			else
							   ESX.ShowNotification(("You have no more Extended Magazine\'s to add.")) 
	...
	local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used6 < scope then
			...
			if currentWeaponHash == GetHashKey("WEAPON_MICROSMG") then
				   ...
				   ESX.ShowNotification(("You have just equipped yourself with a Scope. It will re-equip every return to town.")) 
				   used6 = used6 + 1
			  ...
			  elseif currentWeaponHash == GetHashKey("WEAPON_BULLPUPRIFLE") then
				   ...
				   used6 = used6 + 1
					...
					ESX.ShowNotification(("You do not have a weapon in your hands, or your weapon can not take a Scope."))
				  
			end
			else
							   ESX.ShowNotification(("You have no more Scope\'s to add.")) 
