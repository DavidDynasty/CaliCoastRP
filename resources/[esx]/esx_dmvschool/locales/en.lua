Locales['en'] = {
  ...
  ['passed_test'] = 'you ~g~passed~s~, congratulations!',
  ['failed_test'] = 'you ~r~failed~s~, better luck next time!',
  ['theory_test'] = 'DMV Driving Permit Test',
  ['road_test_car'] = 'driving Test',
  ['road_test_bike'] = 'motorcycle Skills Test',
  ['road_test_truck'] = 'truck Skills Test',
  ['school_item'] = '$%s',
  ['driving_school'] = 'driving School',
  ['press_open_menu'] = '~INPUT_CONTEXT~ ~y~DMV School~s~.',
