Locales ['fr'] = {
  -- weed
  ['weed_pickupprompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter un plan de Cannabis.',
  ['weed_inventoryfull'] = 'vous n\'avez plus assez de place dans votre inventaire pour récolter du Cannabis.',
  ['weed_processprompt'] = 'appuyez ~INPUT_CONTEXT~ pour démarrer la tranformation du Cannabis.',
  ['weed_processingstarted'] = 'transformation du Cannabis en Marijuana...',
  ['weed_processingfull'] = 'transformation annulée. Votre inventaire est plein!',
  ...
  ['weed_processingtoofar'] = 'la transformation a été annulée. Vous êtes sorti de la zone.',

  -- drug dealer
  ['dealer_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour parler avec le Drug Dealer.',
  ...
  ['license_no'] = 'non',
  ['license_bought'] = 'vous avez acheté %s pour $%s',
