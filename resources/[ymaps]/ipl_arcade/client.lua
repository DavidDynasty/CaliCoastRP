...
--EnableInteriorProp(int_arcade1, "entity_set_arcade_set_ceiling_flat") --blue shell
...
--EnableInteriorProp(int_arcade1, "entity_set_arcade_set_derelict_clean_up") -- closed vending machines
...
--EnableInteriorProp(int_arcade1, "entity_set_mural_neon_option_01") --signboard
--EnableInteriorProp(int_arcade1, "entity_set_mural_neon_option_02")--signboard
--EnableInteriorProp(int_arcade1, "entity_set_mural_neon_option_03")--signboard
--EnableInteriorProp(int_arcade1, "entity_set_mural_neon_option_04")--signboard
--EnableInteriorProp(int_arcade1, "entity_set_mural_neon_option_05")--signboard
...
--EnableInteriorProp(int_arcade1, "entity_set_mural_option_01") --wall paint "black and white art"
--EnableInteriorProp(int_arcade1, "entity_set_mural_option_02") --wall paint "black with red,orange,yellow lines"
--EnableInteriorProp(int_arcade1, "entity_set_mural_option_03") --wall paint "cartoon"
EnableInteriorProp(int_arcade1, "entity_set_mural_option_04") --wall paint "black with blue,light blue,white lines"
--EnableInteriorProp(int_arcade1, "entity_set_mural_option_05") --wall paint "spray paint fantasy artwork"
--EnableInteriorProp(int_arcade1, "entity_set_mural_option_06") --wall paint "3D lines"
--EnableInteriorProp(int_arcade1, "entity_set_mural_option_07") --wall paint "motaly color wall"
--EnableInteriorProp(int_arcade1, "entity_set_mural_option_08") --wall paint "Blue space monsters"

--EnableInteriorProp(int_arcade1, "entity_set_floor_option_01") --painted floor "black and goldish squares"
--EnableInteriorProp(int_arcade1, "entity_set_floor_option_02") --painted floor "casino half moon floor"
--EnableInteriorProp(int_arcade1, "entity_set_floor_option_03") --painted floor "pink,red,green paw prints with squares"
EnableInteriorProp(int_arcade1, "entity_set_floor_option_04") --painted floor "black squares with blue grout lines"
--EnableInteriorProp(int_arcade1, "entity_set_floor_option_05") --painted floor "purple with space"
--EnableInteriorProp(int_arcade1, "entity_set_floor_option_06") --painted floor "blue grid"
--EnableInteriorProp(int_arcade1, "entity_set_floor_option_07") --painted floor "small white images blue/black floor"
--EnableInteriorProp(int_arcade1, "entity_set_floor_option_08")--painted floor "purple lighting"
