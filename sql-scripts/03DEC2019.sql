...
-- Dumping data for table essentialmode.addon_account: ~3 rows (approximately)
...
-- Dumping data for table essentialmode.disc_ammo: ~10 rows (approximately)
...
INSERT IGNORE INTO `disc_ammo` (`id`, `owner`, `hash`, `count`) VALUES
	...
	(5, 'steam:1100001083da79f', '-1074790547', 0),
	(6, 'steam:1100001083da79f', '-1063057011', 0),
	(7, 'steam:1100001083da79f', '584646201', 0),
	(8, 'steam:1100001083da79f', '324215364', 0),
...
INSERT IGNORE INTO `disc_inventory` (`id`, `owner`, `type`, `data`) VALUES
	(3, 'steam:110000100bc09b3', 'player', '{"2":{"name":"WEAPON_SNIPERRIFLE","count":42}}'),
	...
	(17, 'steam:1100001083da79f', 'player', '{"2":{"name":"WEAPON_PISTOL","count":1},"1":{"name":"WEAPON_COMBATPISTOL","count":1}}');
...
INSERT IGNORE INTO `items` (`name`, `label`, `weight`, `rare`, `can_remove`) VALUES
	...
	('disc_ammo_pistol', '9MM Ammo', 10, 0, 1),
...
INSERT IGNORE INTO `jobs` (`name`, `label`, `whitelisted`) VALUES
	...
	('miner', 'Miner', 1),
	('poolcleaner', 'Neptunes Pools', 1),
	('reporter', 'Reporter', 1),
	('slaughterer', 'Butcher', 1),
	('tailor', 'Tailor', 1),
...
-- Dumping data for table essentialmode.job_grades: ~12 rows (approximately)
...
-- Dumping data for table essentialmode.properties: ~43 rows (approximately)
...
-- Dumping data for table essentialmode.shops: ~13 rows (approximately)
...
INSERT IGNORE INTO `user_accounts` (`id`, `identifier`, `name`, `money`) VALUES
	(1, 'steam:1100001083da79f', 'black_money', 5145400),
...
CREATE TABLE IF NOT EXISTS `weashops` (
  ...
  `price` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2100 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table essentialmode.weashops: ~100 rows (approximately)
...
INSERT IGNORE INTO `weashops` (`id`, `zone`, `item`, `price`) VALUES
	...
	(14, 'BlackWeashop', 'WEAPON_MICROSMG', 1500000),
	(18, 'BlackWeashop', 'WEAPON_ASSAULTRIFLE', 2000000),
	(20, 'BlackWeashop', 'WEAPON_SPECIALCARBINE', 3500000),
	(35, 'BlackWeashop', 'WEAPON_APPISTOL', 50000),
	(36, 'BlackWeashop', 'WEAPON_CARBINERIFLE', 2500000),
	...
	(2073, 'GunShop7', 'GADGET_PARACHUTE', 15000),
	...
	(2079, 'GunShop7', 'WEAPON_DBSHOTGUN', 42000),
