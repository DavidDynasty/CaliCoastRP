...
REPLACE INTO `items` (`name`, `label`, `weight`, `rare`, `can_remove`, `price`) VALUES
	...
	('grapperaisin', 'Grappe Juice', 1, 0, 1, 0),
	('hamburger', 'Cheese Burger', 1, 0, 1, 5),
	('heartstopper', 'Heart Stopper', 1, 0, 1, 9),
	...
	('ice', 'Ice', 1, 0, 1, 2),
	('icetea', 'Ice-Tea', 20, 0, 1, 2),
	('iron', 'iron', 42, 0, 1, 0),
	('jewels', 'Jewels', 1, 0, 1, 0),
	('joint', 'Joint', 1, 0, 1, 0),
	('jusfruit', 'Grappe Juice', 1, 0, 1, 3),
	('lemonade', 'Yoohoo', 20, 0, 1, 2),
	('lighter', 'Zippo Lighter', 20, 0, 1, 22),
	('lockpick', 'Lockpick', 20, 0, 1, 0),
	('lotteryticket', 'Lottery Ticket', 1, 0, 1, 50),
	...
	('redbull', 'Red Bull', 1, 0, 1, 3),
	('rhum', 'Rum', 1, 0, 1, 0),
	('rhumcoca', 'Rum & Coka', 1, 0, 1, 0),
	('rollingpaper', 'Rolling Paper', 20, 0, 1, 2),
	('sandwich', 'Sandwich', 20, 0, 1, 4),
...
REPLACE INTO `owned_vehicles` (`owner`, `plate`, `vehicle`, `type`, `job`, `stored`) VALUES
	('5d95643a350dcb5aa0f14598a720d4ecd758b87f', 'DDYNASTY', '{"plate":"DDYNASTY","model":-1403128555}', 'car', NULL, 0);
...
-- Dumping data for table essentialmode.user_licenses: ~2 rows (approximately)
/*!40000 ALTER TABLE `user_licenses` DISABLE KEYS */;
REPLACE INTO `user_licenses` (`id`, `type`, `owner`) VALUES
	(5, 'dmv', '5d95643a350dcb5aa0f14598a720d4ecd758b87f'),
	(6, 'drive', '5d95643a350dcb5aa0f14598a720d4ecd758b87f');
...
REPLACE INTO `user_parkings` (`id`, `identifier`, `garage`, `zone`, `vehicle`) VALUES
	(2, '5d95643a350dcb5aa0f14598a720d4ecd758b87f', 'IntegrityWay', 10, '{"modAirFilter":-1,"dirtLevel":3.1,"bodyHealth":1000.0,"modWindows":-1,"modExhaust":-1,"modPlateHolder":-1,"color2":41,"modLivery":-1,"modBackWheels":-1,"modTrunk":-1,"fuelLevel":58.3,"modArchCover":-1,"modTurbo":false,"modSpeakers":-1,"modSpoilers":-1,"modRoof":-1,"modFrontBumper":-1,"modStruts":-1,"color1":4,"modFender":-1,"modSideSkirt":-1,"wheels":7,"wheelColor":156,"modDoorSpeaker":-1,"modSeats":-1,"modBrakes":-1,"modAerials":-1,"tyreSmokeColor":[255,255,255],"modTrimA":-1,"modHydrolic":-1,"modSmokeEnabled":false,"modXenon":false,"modShifterLeavers":-1,"plate":"KTMRKZLU","modSteeringWheel":-1,"modDashboard":-1,"xenonColor":255,"modVanityPlate":-1,"windowTint":-1,"modArmor":-1,"plateIndex":0,"neonEnabled":[false,false,false,false],"extras":[],"modOrnaments":-1,"pearlescentColor":111,"engineHealth":1000.0,"modEngineBlock":-1,"modHood":-1,"modTank":-1,"modFrontWheels":-1,"modAPlate":-1,"modRearBumper":-1,"modTrimB":-1,"modHorns":-1,"modSuspension":-1,"modEngine":-1,"modGrille":-1,"modFrame":-1,"model":-1403128555,"modRightFender":-1,"neonColor":[255,0,255],"modDial":-1,"modTransmission":-1}');
